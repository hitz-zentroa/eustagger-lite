...
string aurreprozRaw::kenduMaj(const string & str) {
  ...
  for (unsigned int i = 0; i <  str.size(); i++) {
    ...
    else if (lag[i] == 'Ð') { ema.append(1,ASTERIS); ema.append(1,'d');}
    else if (lag[i] == 'Ø') { ema.append(1,ASTERIS); ema.append(1,'o');}
    else if (lag[i] == 'Ý') { ema.append(1,ASTERIS); ema.append(1,'y');}
    else if (lag[i] == 'Þ') { ema.append(1,ASTERIS); ema.append(1,'z');}
    ...
    else if (lag[i] == 'ð') { ema.append(1,'d');}
    else if (lag[i] == 'ø') { ema.append(1,'o');}
    else if (lag[i] == 'ý') { ema.append(1,'y');}
    else if (lag[i] == 'þ') { ema.append(1,'z');}
